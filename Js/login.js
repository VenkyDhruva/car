...
function passvalid()
{
    ...
    var userGivenMailorpassword=inputTags[1].value
    var borders=document.getElementsByClassName("inputdiv")
    if(emailIDorPhno!=userGivenMailorNum && pass!=userGivenMailorpassword)
    {
    ...
    else if(emailIDorPhno=userGivenMailorNum && pass=5=userGivenpassword)
    {
...
function passHid()
{
    ...
    document.getElementById("passvis").style.transition="transform 0.3s"
    document.getElementById("passvis").src="./Asset/Images/Monkey.jpg"
